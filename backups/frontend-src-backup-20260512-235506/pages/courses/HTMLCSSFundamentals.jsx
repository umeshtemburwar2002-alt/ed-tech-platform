...
const HTMLCSSFundamentals = () => {
  ...
  const courseData = {
    ...
    description: 'Learn HTML and CSS from scratch and build beautiful, responsive websites. This comprehensive course covers everything from basic HTML tags to advanced CSS techniques including Flexbox, Grid, and responsive design.',
    instructor: {
      name: 'Rahul Sharma',
      title: 'Senior Frontend Developer',
      experience: '8+ years',
      image: '👨‍💻',
      bio: 'Rahul is a senior frontend developer with expertise in modern web technologies. He has worked with top tech companies and has taught thousands of students.'
    },
    stats: {
      duration: '4 weeks',
      lessons: 24,
    ...
    skills: ['HTML5', 'CSS3', 'Responsive Design', 'Flexbox', 'CSS Grid', 'Web Accessibility'],
    requirements: [
    ...
    outcomes: [
      ...
      'Create beautiful layouts with CSS',
  ...
  const curriculum = [
    ...
    },
    {
      ...
      topics: [
        ...
        'Project: Navigation Bar and Card Layout'
      ]
    },
    {
      id: 6,
  ...
  const projects = [
    {
      ...
      description: 'Build a complete personal portfolio website showcasing your skills and projects',
    ...
    },
    {
      ...
      description: 'Create a professional business landing page with modern design',
    ...
    },
    {
      ...
      description: 'Design and develop a product page for an e-commerce website',
      skills: ['Advanced CSS', 'Animations', 'Responsive Design'],
      duration: '5-6 hours',
      difficulty: 'Intermediate'
    }
  ];
  ...
  const testimonials = [
    {
      ...
      image: '👩‍💻',
      rating: 5,
      text: 'This course gave me a solid foundation in HTML and CSS. The projects were practical and helped me build a great portfolio.'
    },
    {
      name: 'Amit Kumar',
      ...
      image: '👨‍💼',
      rating: 5,
      text: 'Excellent course! Rahul sir explains everything clearly. I can now build responsive websites confidently.'
    },
    {
      name: 'Sneha Patel',
      role: 'UI/UX Designer',
      image: '👩‍🎨',
      rating: 5,
      text: 'Perfect for beginners. The step-by-step approach and hands-on projects make learning enjoyable and effective.'
    }
  ];
  ...
  const handleEnrollment = () => {
    ...
    setIsEnrolled(true);
    toast.success('Successfully enrolled in HTML & CSS Fundamentals!');
  };
  ...
  const handleStartLearning = () => {
    ...
    navigate('/course-player/html-css-fundamentals');
  };
    ...
    <div className="min-h-screen bg-richblack-900 text-white">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-300 shadow-2xl px-8 py-4 text-lg font-bold rounded-xl flex items-center justify-center gap-3"
                >
                  <FaPlay />
                  {isEnrolled ? 'Continue Learning' : 'Start Learning Free'}
                </button>
                <button className="border-2 border-blue-500 text-blue-400 hover:bg-blue-500 hover:text-white transition-all duration-300 px-8 py-4 text-lg font-bold rounded-xl flex items-center justify-center gap-3">
                  <FaBookmark />
                  Save for Later
                </button>
              </div>
            ...
            >
              <div className="bg-richblack-800 rounded-2xl p-8 border border-richblack-700">
                <div className="text-center mb-6">
                  ...
                  <p className="text-blue-400 font-semibold">{courseData.instructor.title}</p>
                ...
                {curriculum.map((module, index) => (
                  <div key={module.id} className="bg-richblack-800 rounded-xl border border-richblack-700">
                    ...
                    >
                      ...
                      <FaArrowRight className={`text-blue-400 transition-transform duration-300 ${
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {projects.map((project, index) => (
                  <div key={project.id} className="bg-richblack-800 rounded-xl p-6 border border-richblack-700 hover:border-blue-500 transition-all duration-300">
              ...
              <div className="bg-richblack-800 rounded-2xl p-8 border border-richblack-700">
                <div className="flex flex-col md:flex-row items-center gap-8">
                  <div className="text-center">
                    ...
                    <p className="text-blue-400 font-semibold text-lg">{courseData.instructor.title}</p>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-richblack-800 border-t border-richblack-700 p-4 z-20">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <button
            onClick={handleStartLearning}
            className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-300 shadow-2xl px-8 py-3 text-lg font-bold rounded-xl flex items-center gap-3"
          >
            <FaPlay />
