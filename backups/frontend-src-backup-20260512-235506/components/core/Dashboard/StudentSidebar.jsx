...
const sidebarLinks = [
  ...
  { id: "enrolled-courses", label: "My Courses", icon: FaBook, path: "/dashboard/enrolled-courses" },
  { id: "learning-path", label: "Learning Path", icon: FaChartLine, path: "/dashboard/learning-path" },
  { 
    id: "quiz", 
    label: "Quiz", 
    icon: FaKeyboard,
    subItems: [
      { id: "quiz-scheduled", label: "Scheduled", path: "/dashboard/quizzes/scheduled" },
      { id: "quiz-completed", label: "Completed", path: "/dashboard/quizzes/completed" }
    ]
  },
  ...
  { 
    ...
    icon: FaStar,
    subItems: [
      { id: "feedback-pending", label: "Pending", path: "/dashboard/feedback/pending" },
      { id: "feedback-history", label: "History", path: "/dashboard/feedback/history" }
    ]
  },
  ...
  { id: "support", label: "Help & Support", icon: FaQuestionCircle, path: "/dashboard/support" },
];
        ...
        <div className="relative z-10 flex flex-col h-full bg-black/40">
          ...
          <div className="relative p-8 border-b border-white/10 overflow-hidden group/header">
            ...
            <Link to="/" className="relative z-10 flex items-center gap-3 group">
              <div className="w-10 h-10 bg-cyan-500 rounded-xl flex items-center justify-center shadow-[0_0_20px_rgba(0,180,216,0.4)] group-hover:scale-110 transition-transform">
                <FaGraduationCap className="text-white text-xl" />
              </div>
              <div className="overflow-hidden whitespace-nowrap">
                <h1 className="text-xl font-bold tracking-tight text-white">EdTech <span className="text-cyan-400">Pro</span></h1>
